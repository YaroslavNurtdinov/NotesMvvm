...
import com.example.notesmvvm.nurtdinov.databinding.FragmentStartBinding
...
class StartFragment : Fragment() {
    ...
    private fun initialization() {
        ...
        mBinding.btnFirebase.setOnClickListener {
            ...
            mBinding.btnLoginFirebase.visibility = View.VISIBLE
            ...
            mBinding.btnLoginFirebase.setOnClickListener {
                ...
                if (inputEmail.isNotEmpty() && inputPassword.isNotEmpty()) {
                    ...
                    showToast(getString(R.string.input_wrong_email_password))
                }
            }
        }
